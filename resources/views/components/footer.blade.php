<footer class="footer text-white py-5" style="background-color: #E85C0D;">
    <div class="container">
        <div class="row text-center">
            ...
            <div class="col-md-3">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="#" class="text-white text-decoration-none" data-bs-toggle="modal" data-bs-target="#privacyModal">Políticas de Privacidad</a></li>
                </ul>
            </div>
            ...
            <div class="col-md-3">
                ...
                <p><i class="fas fa-envelope"></i> <a href="mailto:info@aymicookie.com" class="text-white">info@aymicookie.com</a></p>
        ...
        <div class="text-center mb-3">
            ...
            <button class="btn btn-outline-light" data-bs-toggle="modal" data-bs-target="#privacyModal">Ver Políticas de Privacidad</button>
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p>Recopilamos información personal cuando interactúas con nuestra página web, incluyendo nombre, dirección de correo electrónico y datos de pago cuando realizas compras.</p>
                
                <h6>2. Uso de la Información</h6>
                <p>Utilizamos la información recopilada para procesar pedidos, mejorar la experiencia del usuario y enviar actualizaciones sobre productos y promociones.</p>
